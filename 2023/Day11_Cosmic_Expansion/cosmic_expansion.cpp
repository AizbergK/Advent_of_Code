...
long long get_distance(coord* first_star, coord* second_star, int expansion_value) {
    ...
    distance += std::abs((second_star->x + second_star->x_exp_coef * expansion_value) - (first_star->x + first_star->x_exp_coef * expansion_value));
    distance += std::abs((second_star->y + second_star->y_exp_coef * expansion_value) - (first_star->y + first_star->y_exp_coef * expansion_value));
